				    ...
				    <div class="container-fluid">
				        <section id="alta" style="display: none">
            				<form id="frmAlta">
								<div class="row">
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="form-group">
											...
											<input type="text" id="pregunta" class="form-control " required="" placeholder="Escribe la Pregunta">
										</div>
									</div>
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="form-group">
								...
								<div class="row">
									<div class="col-lg-12">
										<button type="button" id="btnLista" class="btn btn-login  btn-flat  pull-left">Lista de Preguntas</button>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
								<div class="form-group">
									<label for="preguntaE">Pregunta:</label>
									<input type="text" id="preguntaE" class="form-control " autofocus required="" placeholder="Escribe la Pregunta">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
								<div class="form-group">
									<label for="categoriaE">Categoría:</label>
									<select  id="categoriaE" class="select2 form-control " style="width: 100%">
									</select>
								</div>
							</div>
							<hr class="linea">
