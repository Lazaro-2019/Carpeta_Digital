								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="form-group">
											...
											<input type="password" id="vContra" class="form-control " required="" placeholder="Vuelve a Escribir la Contraseña">
										</div>
									</div>
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="form-group">
									...
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="form-group">
											<label for="categoriaUser">Area:</label>
											<select  id="categoriaUser" class="select2 form-control " style="width: 100%">
											</select>
										</div>
									</div>
									<hr class="linea">
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
									<div class="form-group">
										...
										<input type="text" id="usuarioE" class="form-control " required="" placeholder="Escribe el Usuario" disabled>
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="form-group">
											<label for="categoriaUserE">Area:</label>
											<select  id="categoriaUserE" class="select2 form-control " style="width: 100%">
											</select>
										</div>
									</div>
							</div>		
