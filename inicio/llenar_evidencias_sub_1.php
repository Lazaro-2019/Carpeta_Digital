...
<div class="row">
    <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
        <button class="btn btn-login btn-block animated zoomIn " onclick="llenar_preguntas_subcaja_1(
...
<div class="panel-group accordion accordion2 animated zoomIn" id="accor2" role="tablist">
<?php
    ...
    for ($j=1; $row=mysql_fetch_row($consulta2) ; $j++) 
    { 
...
?>
            ...
            <div class="panel panel-color ">
                <div class="panel-heading " role="tab" id="<?php echo "head2".$j;?>">
                    <h4 class="panel-title ">
                        <a href="<?php echo "#coll2".$j;?>" data-toggle="collapse" data-parent="<?php echo "#accor2".$j;?>">
                            <?php echo $nombre_archivoSub; ?>
                        </a>				
                    </h4>
                </div>

                <div id="<?php echo "coll2".$j;?>" class="panel-collapse collapse ">
                        ...
                        <?php
                            ...
                            { 
                                ...
                                if (file_exists($archivo))
                                {
                                    ...
                                    $Icono="<i class='fas fa-times fa-2x'></i>";
                                }
                        ?>
